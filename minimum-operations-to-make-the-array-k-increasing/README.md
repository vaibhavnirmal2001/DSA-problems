<h2>2111. Minimum Operations to Make the Array K-Increasing</h2><h3>Hard</h3><hr><div><p>You are given a <strong>0-indexed</strong> array <code>arr</code> consisting of <code>n</code> positive integers, and a positive integer <code>k</code>.</p>
