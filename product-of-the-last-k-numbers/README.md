<h2>1352. Product of the Last K Numbers</h2><h3>Medium</h3><hr><div><p>Design an algorithm that accepts a stream of integers and retrieves the product of the last <code>k</code> integers of the stream.</p>
